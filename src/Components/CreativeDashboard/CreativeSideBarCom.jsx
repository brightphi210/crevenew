...
const CreativeSideBarCom = ({show}) => {
  ...
  return ( 
    <div className={show === false ? 'hidden z-30 bg-black lg:w-[15rem] w-full fixed h-screen lg:block  text-white ' : 'block bg-black lg:w-[15rem] w-full fixed h-screen lg:block  text-white z-50'}>
        ...
        <div>
            ...
            <ul className='flex flex-col gap-8 2xl:gap-8 xl:gap-6 lg:gap-6 md:gap-3 p-6 pb-10 2xl:pb-10 xl:pb-3 lg:pb-2'>
                ...
                <Link to={'/creative-dashboard-profile'}>
                  <li className='text-lg hover:text-accent cursor-pointer flex items-center gap-3'><CiUser className=''/> Profile Overview</li>
                </Link>
        ...
        <div>
            ...
            <ul className='flex flex-col gap-5 2xl:gap-8 xl:gap-5 lg:gap-3 md:gap-3 p-6'>
                ...
                <Link to={'/creative-dashboard-profile-update'}>
                  <li className='text-lg hover:text-accent cursor-pointer flex items-center gap-3'><CiUser className=''/>Edit Profile</li>
                </Link>
