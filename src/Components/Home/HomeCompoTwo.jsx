...
const HomeCompoTwo = () => {
  return (
    <div className=''>
        ...
        <h2 className='text-center 2xl:text-4xl pb-10'>A whole world of  <br /> <span className='mycolor'>talent</span> at your fingertips</h2>
        <div className='flex bg-neutral-200 lg:py-20 py-10 2xl:grid 2xl:grid-cols-4 2xl:mx-[10rem] mx-5  2xl:px-20 rounded-2xl xl:grid xl:grid-cols-3 lg:grid lg:grid-cols-2 flex-col  justify-between lg:px-[10rem] px-5 lg:gap-5 gap-8'>
            ...
            <div className='text-center bg-white rounded-2xl shadow-md w-full py-5 pb-10 flex justify-center items-center'>
                <div>
            ...
            <div className='text-center mycolor2 rounded-2xl shadow-md w-full py-5 pb-10 flex justify-center items-center'>
                <div className=''>
                    <div className='bg-neutral-100 p-5 mb-4 m-auto flex justify-center items-center w-fit rounded-full'>
            ...
            <div className='text-center mycolor2 rounded-2xl shadow-md w-ful flex justify-center items-center py-5  pb-10'>
                <div>
                    <div className='bg-neutral-100  p-5 mb-4 m-auto flex justify-center items-center w-fit rounded-full'>
                        <img src={icon3} alt="" className='2xl:w-10 xl:w-10 lg:w-10 w-10'/>
                    </div>
