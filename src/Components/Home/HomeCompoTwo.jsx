...
const HomeCompoTwo = () => {
  return (
    <div className=''>
        <div className='flex bg-black lg:py-20 py-20 2xl:flex-row xl:grid xl:grid-cols-3 lg:grid lg:grid-cols-2 flex-col  justify-between lg:px-[10rem] px-5 lg:gap-5 gap-8'>
            <div className='text-center bg-white rounded-2xl shadow-md w-full py-5 pb-10'>
                <div className='bg-neutral-100 p-8 mb-4 m-auto flex justify-center items-center w-fit rounded-full'>
                    <img src={icon2} alt="" className='2xl:w-14 xl:w-10 lg:w-10 w-10'/>
                </div>
            ...
            <div className='text-center bg-neutral-900 rounded-2xl shadow-md w-full py-5 pb-10'>
                <div className='bg-neutral-100 p-8 mb-4 m-auto flex justify-center items-center w-fit rounded-full'>
                    <img src={icon1} alt="" className='2xl:w-14 xl:w-10 lg:w-10 w-10'/>
                </div>
            ...
            <div className='text-center bg-white rounded-2xl shadow-md w-full py-5  pb-10'>
                <div className='bg-neutral-100 p-8 mb-4 m-auto flex justify-center items-center w-fit rounded-full'>
                    <img src={icon3} alt="" className='2xl:w-14 xl:w-10 lg:w-10 w-10'/>
                </div>
        ...
        <div className='flex lg:flex-row flex-col-reverse py-14 gap-10 2xl:px-[13rem] xl:px-[5rem] lg:px-[5rem] px-6 items-center bg-neutral-100'>
