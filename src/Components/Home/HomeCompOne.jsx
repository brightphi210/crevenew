        ...
        <div className='w-full lg:px-0 px-6 lg:pt-0 lg:pb-0 pt-[8rem] pb-16'>
            <div className=' text-black text-center' data-aos="fade-up" data-aos-duration="1000">
                ...
                <div className='flex gap-2 justify-center m-auto lg:mt-3 mt-0'>
                    <button className='mycolor2 shadow-[rgba(0,_0,_0,_0.25)_0px_25px_50px_-12px] text-xs  text-white py-4 2xl:text-lg xl:py-3 lg:py-3 cursor-pointer px-8 lg:mt-3 mt-6 rounded-md flex items-center gap-3'>
