        ...
        {isLoading === true ? <MyLoader />  : <>
            ...
            <>
              {showAllRequest === 1 && 
                <div className='grid 2xl:grid-cols-4 xl:grid-cols-3 lg:grid-cols-2 grid-cols-1 gap-5 w-full mt-5 mb-10'>
                    {allRequest.map((request)=>(
                        ...
                        <div className='col-span-1 mb-5 flex-col gap-5 bg-white border border-neutral-200 rounded-md'>
                            ...
                            <div className='flex gap-5 items-center border-b border-b-neutral-200 p-5 py-3'>
                                ...
                                <div className='ml-auto'>
                                  {request.status === true ?
                                      <p className=' bg-green-500 w-fit text-xs rounded-full gap-3 py-1.5 px-4 text-white '>
                                          Approved
                                      </p>
                                      :
                                      <p className=' bg-yellow-500 w-fit text-xs rounded-full gap-3 py-1.5 px-4 text-white '>
                                          Pending
                                      </p>
                                  }
                                </div>
                                ...
                                <div className='flex flex-row items-center gap-3 my-5'>
                                    {request.status === true &&
                                      <Link to={`tel:${request.phone_number}`} className='w-full'>
                                          <button className='border border-neutral-300 py-2.5 rounded-md text-sm w-full'>Call Talent</button>
                                      </Link>
                                    }

                                    <button  onClick={()=>{setShowAllRequest(2); setSelectedBook(request)}} 
                                        className='text-sm bg-black text-white py-2.5 rounded-md m-auto justify-center font-semibold w-full flex items-center gap-3'>
              ...
              <>
                ...
                <form onSubmit={handlePayment} className="2xl:w-[50%] xl:w-[65%] lg:w-[80%] relative w-full flex justify-center m-auto rounded-lg lg:my-5 mt-5 mb-0 py-5">
                  <div className="lg:p-8 p-5 w-full bg-white rounded-lg shadow-md">
                  <button className="absolute top-5 right-5 py-2 px-3 w-fit flex bg-white text-black rounded-full" onClick={()=>setShowAllRequest(1)}>✕</button>
                    {selectedBook.talent_profile &&
                        <div className='flex gap-5 items-center border-b border-b-neutral-200 p-5 py-3'>
                            <div className='w-12 h-12 flex justify-center items-center overflow-hidden rounded-full border border-neutral-200'>
                                <img src={selectedBook.talent_profile.profile_pics} alt="" className='w-12 h-12 object-cover'/>
                    ...
                    <div className='flex items-center mb-4'>
                      <h1 className="text-xl font-bold">Pay with crypto (Solana Pay)</h1>
                      <div className='ml-auto'>
